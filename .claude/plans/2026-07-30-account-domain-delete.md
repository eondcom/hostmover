...
아래 4건은 모두 결정되어 개발 스펙에 반영됐다:
**[2026-07-30-account-domain-delete-SPEC.md](2026-07-30-account-domain-delete-SPEC.md) §2** (Codex 작업 지시서).
결정 내용은 그 문서가 기준이며, 여기 적힌 내용은 판단 근거로만 남긴다.
